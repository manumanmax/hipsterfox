package com.funforfox.histerfox.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("hipsterfox");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("hipsterfox");
        ...
        config.getMapConfigs().put("com.funforfox.histerfox.domain.*", initializeDomainMapConfig(jHipsterProperties));
